...
public class MusicService extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "7008", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-7008/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response song() {
    ...
    if(res_condition) {
      JSONObject resuilt = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_OK).entity(resuilt.toJSONString()).build();
    }
    return null;
  }
